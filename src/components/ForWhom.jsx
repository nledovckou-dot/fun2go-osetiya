...
const CARDS = [
  {
    text: 'тем, кто забыл как смотреть на закат в горах и наслаждаться жизнью по-настоящему',
    image: 'https://static.tildacdn.com/tild6131-6430-4561-b233-643339343232/IMG_1840.jpeg',
    alt: 'Горный пейзаж Осетии на закате',
    direction: 'left',
  },
  {
    text: 'тем, на кого свалились все проблемы этого мира, и кто мечтает о тотальной перезагрузке',
  ...
  {
    text: 'мужчинам и женщинам, которые вздрагивают от телефонных звонков, переговоров и слова "надо"',
    image: 'https://static.tildacdn.com/tild3730-3462-4935-b236-623135353738/IMG_2457.jpeg',
    alt: 'Тишина и покой в горах Осетии',
    direction: 'left',
  },
  {
    text: 'тем, кто привык к хорошему уровню путешествий, где идеальный баланс между ценой, качеством и незабываемыми впечатлениями',
