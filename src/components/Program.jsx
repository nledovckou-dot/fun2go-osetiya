...
const DAYS = [
  {
    ...
    items: [
      ...
      'Обед — осетинские пироги, шашлык, горный чай. Ты поймёшь, зачем сюда ехал',
  ...
  },
  {
    ...
    items: [
      ...
      'Горные качели и арт-объект «Буква AE» — тот самый кадр для Instagram',
      ...
      'Парящая лавочка на 2560 м — сесть, выдохнуть, загадать желание',
  ...
  },
  {
    ...
    items: [],
    note: 'Ты уезжаешь другим. Не уставшим от отпуска — а перезагруженным.',
      ...
      <div className="max-w-container mx-auto px-6 md:px-10 lg:px-12">
        <FadeInUp>
          ...
          <p className="text-text-light text-base md:text-[17px] text-center mb-12 md:mb-16 max-w-text mx-auto">
            Утро — приключение — отдых. Без спешки, без «галопа по Европам». Ты здесь, чтобы проживать, а не пробегать.
          </p>
        </FadeInUp>
