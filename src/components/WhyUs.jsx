...
const REASONS = [
  {
    ...
    text: 'И как сделать так, чтобы в горах вас никто не побеспокоил.',
  },
  {
    Icon: MountainSnow,
    title: 'Выбираем видовые отели',
    text: 'Где закаты и рассветы в горах станут вашей новой реальностью.',
  },
  {
    Icon: Users,
    title: 'Подбираем группу',
    text: 'Тех, кто идеально подойдёт по эмоциям и настроению.',
  },
  {
    Icon: Compass,
    title: 'Наши гиды — эмпаты',
    text: 'Они точно знают, как открыть вам мир другими глазами. Поверьте, они лучшие психологи!',
  },
]
      ...
      <div className="max-w-container mx-auto px-6 md:px-10 lg:px-12">
        <FadeInUp>
          <h2 className="font-heading font-bold text-[32px] md:text-[48px] text-text text-center mb-12 md:mb-16 tracking-tight leading-tight">
            Почему мы точно вернём вас новыми и заряженными в эту жизнь:
          </h2>
        </FadeInUp>
